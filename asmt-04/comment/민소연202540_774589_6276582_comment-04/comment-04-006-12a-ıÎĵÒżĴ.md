---
title: 005-12 민소연의 코멘트a (과제-04) 
layout: home
nav_order: 12
parent: 005-03 김성민 (과제-04)
permalink: /asmt-04/005-03/comment-005-12
---
...
이 글은 "공론화위원회의 결과를 시민의 의견으로 간주하는 것은 민주적인가?"라는 주제를 중심으로, 전개하고있다. 그러나 서론에서 제시된 본론의 전개 순서가 예측했던 바와 실제 본문에서 구현되는 방식이 차이가 있다. 논증1과 논증2가 각각 본론의 1,3에 나누어져 나타나기 때문이다. 그렇다면 재반박 단락은 구조적 보완이 필요하다. 반론이 공격하는 핵심을 정확히 반박하지 못하고 또 다른 내용의 논증을 재반박에서 새롭게 제시하고 있기 때문이다. 이는 하나의 명확한 주장 구조를 중심으로 설계된 논증으로 보기는 어렵다. 결과적으로는 본문 전체에서 논점 정리가 타당하다고 느껴지기 때문에 글의 구조를 다시 설계한다면 훨씬 체계적인 글이 될 것이다. 
