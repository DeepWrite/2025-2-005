---
title: 005-13 박승열의 코멘트a (과제-04) 
layout: home
nav_order: 13
parent: 005-04 박현규 (과제-04)
permalink: /asmt-04/005-04/comment-005-13
---
...
제시문은 미 대선이 치러질 때마다 논란이 되는 승자독식 선거인단 제도에 대해 NPVIC라는 대안을 소개하고, 그 대안이 가지는 유용성에 대해 효과적으로 설명함으로써 사회적으로 문제가 되는 사안에 일정한 기여를 제공하는 내용을 담고 있다. 그러나 글 전반에 걸쳐 인용되거나 근거가 되는 미국 헌법의 여러 조항과 원칙, 그리고 그 해석에 대해서는 원문을 제공하지 않거나 그러한 해석을 정당화하는 자료를 뒷받침하지 않아, 독자의 이해를 저해하고 나아가 글의 논리를 비판적으로 평가하는 데에 명확한 한계를 긋는다.

또한 반론과 재반박 부분에 있어 개선이 필요하다. 반론에서 제기하는 문제는 NPVIC 제도의 적법성과 안정성이다. 제시문은 이에 대해 재반박에서 적법성에 대해서는 1892년의 연방대법원 판례를 통해 재진술하면서도, 정작 그 판례의 내용과 구체적인 요지에 대해서는 언급하지 않는 부실한 논증을 보인다. 또한 안정성에 대해 재반박에서 제시문은 현 선거제보다 NPVIC 제도가 보다 안정적임을 지적하는데, 이때 제시문에서 짚는 현 선거제의 불안정성 중 부정행위에 대해서는 논쟁의 여지가 많아 근거로 적절하지 않다. 
