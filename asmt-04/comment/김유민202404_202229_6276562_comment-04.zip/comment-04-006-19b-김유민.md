---
title: 005-19 김유민의 코멘트b (과제-04) 
layout: home
nav_order: 19
parent: 005-06 장제성 (과제-04)
permalink: /asmt-04/005-06/comment-005-19
---
...
서론은 최근 사회적으로 큰 이슈가 된 특정한 배경을 제시하며 시작된다. 그 후 서로 대립되는 주장을 다룬 후, 글쓴이의 주장이 어디에 있는지를 명확히 보인다. 그 후, 앞으로의 논증이 어떻게 전개될지를 설명한다. 다만, 대립 구조를 다룰 때 참고문헌에서 확인할 수 있는 기존 학자들의 선행연구를 언급한다면 해당 논의를 독자들이 더 잘 이해할 수 있을 것이다.

본론의 경우, 군인의 명령 수행에 있어 수행 방식은 도덕적 책임 규명의 대상이 된다는 논지로 논증이 전개된다. 이 중 2번 문단의 경우 강제되었다는 것이 도덕적으로 면책될 수 있는 이유가 구체적으로 제시되면 좋을 것이다. 근거가 다소 빈약하다는 인상을 줄 수 있어 보인다. 또한, 2번과 3번 문단이 유기적으로 연결된다면 조금 더 읽기 쉽고 논지를 잘 전달할 수 있을 것이다.
