---
title: 005-26 이현석의 코멘트c (과제-04) 
layout: home
nav_order: 26
parent: 005-22 이예준 (과제-04)
permalink: /asmt-04/005-22/comment-005-26
---
...
이 글은 'AI를 활용한 창작물은 인간의 창작물로 볼 수 있는가?'를 주제로 하여 AI 콘텐츠의 저작권과 관련된 문제를 다루고 있다. 먼저 서론에서는 양립할 수 없는 딜레마와 각 주장과 관련된 학자들의 입장을 제시하고 있으며, '예측 가능성'을 중심으로 논증을 펼치고 있다. 필자의 주장 또한 명확하게 드러나 있고, 번호를 통해 서술 순서를 제시하고 있다. 다음으로 본론에서는 '인간이 만든 콘텐츠이려면, 산출에 대해 예측 가능해야 한다'는 첫 번째 전제와 'AI 콘텐츠라도 인간이 예측 가능하다'는 두 번째 전제를 통해 결론에 다다르는 좋은 논증 구조를 가지고 있으며, 첫 번째 전제에서 제시한 2가지 사례와 두 번째 전제에서 제시한 사례 또한 전제와 유기적으로 연결되는 좋은 예시로 보인다. 다만, 반론과 재반박 부분에서는 아쉬움이 남는다. 필자의 논증은 2가지 전제로 구성되어 결론으로 이르는 구조를 띄고 있는데, 필자가 제시한 반론은 2가지 전제와 관련하여 논증의 약점을 지적하기보다는 '소통적 행위'라는 단순히 또 다른 근거를 제시하고 있다. 이를 보완하기 위해 첫 번째 전제에서 '예측 가능하더라도 인간이 만든 콘텐츠로 볼 수 없는 경우가 있다'와 같이 논증의 약점을 지적하는 반론을 제시하면 좋을 것 같다. 
