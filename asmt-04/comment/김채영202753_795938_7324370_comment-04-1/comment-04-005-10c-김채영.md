---
title: 005-10 김채영의 코멘트c (과제-04) 
layout: home
nav_order: 10
parent: 005-14 하지원 (과제-04)
permalink: /asmt-04/005-14/comment-005-10
---

# 과제-0405-6단락 논증에세이에 대한 코멘트
...
이 글은 트랜스젠더 여성 선수의 여성 경기 참여를 주제로 공정성 문제에 대해 다루고 있다. 스포츠 규정이 사회적 가치와 규범을 반영한다는 점을 제시하여 트랜스젠더 여성의 참가에 대해 Hilton과 Lundberge, Cunningham과 Harper의 상반된 입장을 정리하였으며, 핵심 논제와 논증 전략이 잘 드러나 있다. 본론에서는 스포츠 공정성을 정의하고 Cunningham과 Jones의 연구를 활용하여 과학적 근거가 부족함을 지적하고 실제는 경기력이 다양한 요인으로 결정된다는 점을 논증하였다. 근거 간의 연결성 및 논리적 흐름이 잘 구성되어 있다. 예상 반론 또한 근력과 골격 구조가 공정성을 위협한다는 약점을 정확히 지적하였고, 이에 대해 실증적 데이터가 부족하다는 근거를 들어 논리적으로 재반박하여 주장의 설득력을 강화하고 있다. 다만 반박 부분에서 다른 연구나 구체적인 수치를 넣어 보강한다면 더욱 탄탄한 글이 될 수 있을 것 같다. 결론에서 본론의 내용을 구조적으로 잘 요약했지만 연결 표지를 조금 더 명확히 하면 독자가 논증 구조를 파악하기에 더 용이할 것 같다.  
