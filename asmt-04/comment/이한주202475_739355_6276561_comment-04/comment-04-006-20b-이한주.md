---
title: 005-20 이한주의 코멘트b (과제-04) 
layout: home
nav_order: 20
parent: 005-14 박솔민 (과제-04)
permalink: /asmt-04/005-14/comment-005-20
---
...
이 글은 넛지가 시민의 자율성을 보장하는 정당한 개입이 될 수 있는가를 중심으로, 설득의 이상적 조건과 자율성 개념을 바탕으로 논증을 주장한다. 서론을 보면 논증을 소개하는 부분과 서술 순서를 안내하는 부분이 잘 구분되어 있지만, 논증을 소개하는 부분에서 설득의 이상적 조건과 자율성 개념이 명확히 드러나 있지 않다. '결과가 바람직하다는 이유만으로 정당화될 수 없다'라고만 서술이 되어 있어 논증이 어떻게 진행될 것인지를 핵심 개념과 연결지어 구체적으로 서술하면 좋을 것 같다. 또한 결론 부분에서 논증을 정리한 부분은 일목요연하고 좋지만, 함의에 관련된 부분이 없어 추가하면 좋을 것 같다.  기존 논의에서 나아가 어떠한 특징이 있고 한계가 있는지를 언급한 선행연구와 연관지어 서술한다면 더욱 완벽한 글이 될 것 같다. 
