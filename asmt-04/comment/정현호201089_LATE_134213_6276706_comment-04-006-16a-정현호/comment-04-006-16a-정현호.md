---
title: 005-16 정현호의 코멘트a (과제-04) 
layout: home
nav_order: 16
parent: 005-07 박현후 (과제-04)
permalink: /asmt-04/005-07/comment-005-16
---
...
## 코멘트
 ...
 해당 글의 서론은 국제적 기후 협약에 대한 배경과 함께 그 운영 원리에 대한 논쟁을 잘 정리한다. 또한 필자의 주장과 그 논증구조가 뚜렷이 드러나며, 이후 서술할 논증 순서와 전개 방향에 대한 간략하고 명확한 서술을 통해 글의 흐름에 대한 독자의 예측성을 높여준다. 이후 본론 1과 본론 2에서는 두가지 논증과 그에 대한 사례를 들어 필자의 주장을 효과적으로 강화한다. 특히 각 본론의 마지막 문장이 중심 논제와의 관계를 재확인하며, 본론과 중심 논제 간의 논리적 연결성을 잘 드러낸다. 다만, 본론1의 사례가 공평성의 고수에 따른 기후협약의 좌절과 긴밀하게 연결되지 않는다. 독자의 입장에서는 해당 사례가 개발도상국들의 선진국에 재정적 지원을 요구한 바에 선진국이 반대했기 때문으로 보일 뿐, 역사적 책임에 따른 공평성의 고수와는 그 관련성이 크게 두드러지지 않기 때문이다.

 다음으로 예상 반론의 경우는 필자의 주장 중 핵심단어인 ‘파레토 최적주의’에 대한 이해가 부족한 입장을 나타낸다. 허나 이는 필자의 논증 중 약점을 지적한다기 보다, 단순히 필자의 언어를 올바르게 이해하지 못한, 반론보다는 오류에 속하는 입장을 소개한다는 점에서 효과적이지 못하다. ‘파레토 최적주의’는 애초에 모든 국가에 피해가 발생하지 않는 상황이나, 이를 피해를 입는다고 오해한 입장을 예상 반론으로 상정했기 때문이다. 때문에 재반론 역시도 필자의 주장 약점에 대한 보완을 하는 기능을 한다기보다, 단순히 오해한 입장에 대한 주장 재확인 정도로 그친다. 

 마지막으로 결론은 본론에서 제시한 논증의 핵심구조를 요약하고, 주장의 의미와 방향을 정리하며 효과적으로 글의 마무리를 맺게끔 기능한다. 특히 전체 글의 내용을 간략하고도 정확하게 잘 요약하는 점이 두드러진다. 또한 논증의 함축 범위를 설정하고, 그것이 악용될 가능성을 차단하며 독자들의 오해를 방지하게 해주는 기능을 잘 수행한다.
