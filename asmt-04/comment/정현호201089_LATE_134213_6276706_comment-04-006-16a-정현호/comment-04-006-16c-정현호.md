---
title: 006-16 정현호의 코멘트c (과제-04) 
layout: home
nav_order: 16
parent: 006-14 박솔민 (과제-04)
permalink: /asmt-04/006-14/comment-006-16
---
...
## 코멘트
  ...
  해당 글의 서론은 넛지라는 주요단어의 설명과 배경을 제시하고, 그에 대한 필자의 주장이 명확하게 드러나있다. 또한 이후 서술할 논증 순서와 전개 방향에 대한 간략하고 명확한 서술을 통해 글의 흐름에 대한 독자의 예측성을 높여준다. 다음으로 이어지는 본론에서는 넛지의 정당하지 않음과 그것이 오히려 시민의 자율성을 침해한다는 논증을 통해 필자의 주장을 구조적으로 강화한다. 또한 각 본문 단락이 간결한데도 불구하고, 독자들을 설득하는 기능을 효과적으로 수행한다. 

 이후 예상 반론에서는 핵심주장의 약점을 지적하는 입장을 살펴보고, 그에 대한 타당하고도 논리적인 재반론을 제시한다. 이를 통해 필자의 주장이 한층 보완되고 주장의 타당성이 더욱 회복되었다. 다만 재반론에서 ‘전기요금 고지서’의 사례를 들 때, 선택을 반성적으로 해석하지 못하는 구조인 디폴트 변경과 무의식적 클릭유도에 관한 구체적 사례 역시 함께 들었다면, 보다 독자 설득력에 있어서 긍정적이었을 것이라는 약간의 한계가 나타난다. (그럼에도 불구하고 반론과 재반론이 논증성과 타당성을 올바르게 갖춰 매우 효과적이었음은 사실이다) 마지막으로 결론 부분은, 본론에서 제시한 논증의 핵심구조를 요약하고, 주장의 의미와 방향을 정리하며 효과적으로 글의 마무리를 맺게끔 기능한다. 특히 전체 글의 내용을 간략하고도 정확하게 잘 요약하는 점이 두드러진다. 다만 해당 결론이 적용 가능한 영역을 명확히 드러내지는 않는다는 점에서 한계를 갖는다. 관련 내용의 적용가능 영역에 대한 언급을 추가한다면, 글의 결론에 대한 독자들의 오해를 방지할 수 있을 것이다.
...
### **4. 형식적 완결성**
- [1] 결론은 새로운 주장 없이, 앞선 논의의 정리와 재강조로 마무리되었다.  
