---
title: 005-19 양서진의 코멘트a (과제-04) 
layout: home
nav_order: 19
parent: 005-03 김지안 (과제-04)
permalink: /asmt-04/005-03/comment-005-19
---
...
이 글은 "비례대표제를 통한 정치적 다양성이 민주주의를 발전시킬 수 있다"는 주장을 정당화하고 있다. 다만 서론에서 핵심 논제를 표현하는 문장을 찾기 어렵고, 글의 서술 순서가 명확히 드러나지 않는다. 선행연구 소개를 통해 글이 다루고자 하는 쟁점을 간접적으로 드러내고 있으나, 선행연구 각각의 한계를 지적해 딜레마를 분명히 드러내면 더 좋을 것 같다. 본론에서 정치적 다양성이 민주주의를 발전시킨다는 주장을 하고 있는데, 그 근거가 부족하다. 다양성이 민주주의를 발전시키는 이유로 다양한 이해관계의 공존을 보장한다는 것을 제시하고 있는데, 이 이유가 정치적 다양성을 가리키는 것으로 보이기 때문이다. 또한 예상 반론이 글의 논리적 취약점을 지적하기보다는 다른 입장을 소개하는 것에 가깝다. 본론1에서 논의된 사항과는 별개의 문제를 제시하고 있기 때문이다. 마지막으로 결론에서는 글의 논증적 구조를 설명하고, 기존 논쟁에 어떤 기여를 했고 어떤 문제를 해결했는지를 언급하면 좋을 것 같다.
