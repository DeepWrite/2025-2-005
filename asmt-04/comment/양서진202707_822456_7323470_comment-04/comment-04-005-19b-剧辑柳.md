---
title: 005-19 양서진의 코멘트b (과제-04) 
layout: home
nav_order: 19
parent: 005-15 최유민 (과제-04)
permalink: /asmt-04/005-15/comment-005-19
---
...
이 글은 다루고자 하는 주제인 "인공지능의 창작물에 저작권을 부여할 수 있는가?"의 실천적 필요성을 구체적으로 제시하고 있다. 다만 서론에서 핵심 논제와 이를 뒷받침할 핵심 논증 전략을 찾기 어렵다. 또한 주제와 관련된 상반되는 입장의 한계를 지적함으로써 딜레마를 분명하게 드러내고 있으나, 이를 다루는 구체적인 선행연구에 대한 언급이 없다. 서론 마지막에 순서를 간략하게 언급한 것으로 보이나 더 명시적으로 서술 순서를 소개하면 좋을 것 같다. 본론의 첫 번째와 두 번째 단락은 각각 핵심 근거를 서술하는 단락으로 보이는데, 단락 간 필연적인 논리적 연결성이 드러나지 않는다. 또한 예상반론을 제시할 때 다른 입장을 소개하기보다는 이 글의 논리적 취약점을 지적하도록 구성하면 좋을 것 같다. 결론에서 논제와 근거가 요약되었고 기존 논쟁에 기여하는 바가 언급된 것은 긍정적이다.
