---
title: 005-19 양서진의 코멘트c (과제-04) 
layout: home
nav_order: 19
parent: 005-23 고보민 (과제-04)
permalink: /asmt-04/005-23/comment-005-19
---
...
이 글은 "SNS에서의 정치적 판단은 그 특성에 영향을 받은 수동적인 동조의 결과"라는 주장을 정당화하고 있다. 다만 배경 서술에서 일반적인 사회현상의 관찰을 나열하기 보다는 쟁점과 밀접하고 직접적으로 관련된 부분만을 소개하는 것이 좋을 것 같다. 또한 주제와 관련된 선행연구가 구체적으로 언급되고 있으나 쟁점과 밀접한 관련은 없어 보인다. 핵심 논제가 명확하게 제시되어 있고 논증 전략 역시 소개되고 있다는 점은 긍정적이다. 다만 근거를 자세히 서술하기 보다는 논증 전략을 중심으로 서술하면 좋을 것 같고, 이후 서술의 순서를 추가적으로 작성하면 좋을 것 같다. 본론에서는 SNS의 특성으로 인해 정보를 신뢰하기 어렵게 되었다는 사실이 왜 사용자를 수동성으로 만드는지에 대한 정당화가 드러나지 않아 근거와 중심 논제의 연결성이 부족하다. 또한 첫 번째와 두 번째 단락이 병렬적이며 논리적 필연적 연결성이 드러나지 않는다. 결론에서는 주장과 근거가 요약되었으나, 기존의 문제를 어떻게 해결했는지에 대해 설명하면 더 좋을 것 같다.
