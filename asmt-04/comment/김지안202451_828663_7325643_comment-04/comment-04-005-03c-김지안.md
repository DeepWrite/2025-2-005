---
title: 005-03 김지안의 코멘트c (과제-04) 
layout: home
nav_order: 03
parent: 005-23 고보민 (과제-04)
permalink: /asmt-04/005-23/comment-005-03
---
...
이 글은 추천 알고리즘에 따른 에코 챔버, 인간 심리적 편향 등 여러 요소로 인해 SNS가 개인의 정치 판단을 수동적으로 결정하도록 만든다고 논증한다. 서론에서는 문제 제기와 선행연구 제시를 통해 논증 배경을 설정하였지만 전개 내용이 조금은 모호하게 제시되어있다. 또한 본론에서는 각 단락 마다 구체적인 연구 결과와 사례를 통해 독자의 이해를 돕고 주장을 구체화한다. 다만, 예상 반론과 재반박, 제한 조건과 같은 부분을 고려하지 않아 SNS의 사용자의 능동적 판단 가능성이나, 미디어 문해력과 같이 SNS를 통한 정치 판단에 대해 이야기할 때 얘기되는 긍정적 효과는 배제되어 있다. 따라서 예상 반론과 재반박, SNS가 정치판단에 대해 갖는 순기능을 포함한다면 훨씬 균형잡힌 글이 될 수 있을 것 같다. 또한 결론 부분에서는 본론 내용을 요약하고 학술적 함의를 제시하였다. 전반적으로 주제와 근거는 명확하지만 서론에서의 내용 전개 방향 제시와 본론과 결론의 논리적 흐름을 강화한다면 더 좋은 글이 될 수 있을 것 같다. 
