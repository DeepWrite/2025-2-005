---
title: (개선) 과제-07 개인별 논증 구조 작성하기 005-21 한도현
layout: home
nav_order: 99
...
# (개선) 과제-07 개인별 논증 구조 작성하기 005-21 한도현 

## 개선 사항 메모

- 자유의 개념이 넓다는 점을 지적받아 국가로부터의 자유(소극적 자유)로 범위를 좁혔다.
- 전제를 뒷받침하는 근거들의 핵심 키워드를 추가시켜 자세하게 서술하였다.
- 재반박의 용어를 다듬어 앞선 논제, 전제와 일관성있게 바꾸었다.
...
| 딜레마/난제 해소/해결 방법 | 사법부 독립 침해시 민주주의 핵심가치인 국가로부터의 자유 침범하므로 사법부 독립 우선 |
...
- 민주주의 제도는 자유에 근거하며 **사법부 독립성 침해**는 민주주의 가치인 국가로부터의 자유를 훼손한다.
...
- **논제:** 사법부 독립은 다수 의견에 의한 사법제도 개입보다 우선한다.
  - **전제1:** 다수 의견에 근거한 사법제도 개입은 사법부의 독립성을 해친다.
    - 비가역적 경로의존성 현상에 의해 민주적 정당성을 표방한 사법부 구조 변경은 권력 견제 기능을 해체한다(Garoupa, Nuno, and Rokspruk, 2024).
    - 결과적으로 포퓰리즘적 헌정후퇴(개헌을 통한 사법부 구조 변경)은 사법부의 독립성 지수를 유의미하게 하락시키는데 이른다(Garoupa, Nuno, and Rokspruk, 2024).
	- 판사 정원 확대, 정년 낮추기등의 '심판 길들이기'는 다수의 지지를 받은 정치권력이 사법부를 '고무도장'으로 전락시켜 민주주의를 훼손시킨다(Levitsky, Ziblatt, 2018).
  - **전제2:** 민주주의 제도는 국가로부터의 자유에 기반한다.
    - 비자유적 민주주의는 위기상황에서 부상할 수 있지만 자유의 자율적 보호기능이 약화되어 장기적으로는 제도의 퇴보로 이어진다(Gratton, Lee, 2023).
    - 즉, 위기상황을 이유로 자유를 포기하는 순간 민주주의는 약화되며 정부가 민주주의를 표방하지만 언론, 사법독립, 시민자유가 침식되어 형식적 민주주의만 남는 비자유적 민주주의의 모순을 일으킨다(Gratton, Lee, 2023). 
    - 경제적 자유는 도덕적 주체성과 책임적 자율성을 실현하기 위한 도구로 민주주의의 정당성의 필요조건이다(Tomasi, 2012).
  - **전제3:** 사법부 독립은 국가로부터의 자유를 강력하게 설명한다.
      - 사법부 독립 지수가 개인의 자유지수와 강한 양의 상관관계를 보인다(Berggren, Niclas, and Jerg Gutmann, 2020).
      - 결국 단순한 선거 민주주의는 국가로부터 개인의 자유를 보장해주지 못하며 사법부 독립이 모든 형태의 개인 자유 증진에 가장 견고한 제도적 요인이다. (Berggren, Niclas, and Jerg Gutmann, 2020)
...
- **재반박:** 자유는 민주주의와 별개의 개념이 될 수 없다. 민주주의는 자기결정권에 의한 선택에 기반하는데 이는 자유로운 시민의 판단이 실현되어야 한다는 의미이다. 자유가 결여된 민주적 절차는 형식적 민주주의에 불과하다. 즉, 다수결 절차만으로는 민주주의의 달성이라 볼 수 없으며 설사 그것을 민주주의라고 하더라도 앞서 언급한 Gratton, Lee의 연구에 따르면 장기적으로 그러한 제도는 민주주의 퇴보를 불러일으킨다.
