---
title: 005-12 민소연의 코멘트c (과제-08) 
layout: home
nav_order: 12
parent: 005-19 김유민 (과제-08)
permalink: /asmt-08/005-19/comment-005-12
---
...
어휘가 어렵지 않게 와닿고, 각각의 문장이 논제를 강화하는 데에 알맞고 일관성이 있다. 
...
학자들의 주장에 대해 필자 본인만의 예시를 들어 설명해주면 더 좋아질 것 같다. 
...
딜레마의 구조가 명확히 드러난다는 인상은 없다. 특정 논제가 나온 배경이 딜레마의 구조에서 비롯되는 것 같지 않다.
...
상호성의 원칙 설명과 충분주의적 관점은 공적 연금제도가 실현되어야 할 방향을 명확히 한다는 점에서 주장하려는 바가 명확하다. 
...
본론의 논증은 논리적이어보이긴 하나, 결론에 다다르는 과정에서 구조가 복잡하긴 하다. 독자의 편의성을 위해 항목화를 잘 해주었으나 너무 과도하게 세분화하여 오히려 복잡하다. 따라서 항목으로 제시된 챕터를 글로 풀어서 쓰고 대신에 문단을 잘 나눠야 할 것 같다. 
...
인용된 문헌이 많은데, 각각을 얕은 수준에서 설명하고 있어서 해당 논변을 적절히 뒷받침 되는지는 알 수 없다. 오히려 인용을 줄이고 하나의 논변을 자세하게 서술하는 것이 더 좋을 것 같다. 
...
딜레마 구조가 불명확한 것에서 비롯되어 선행 연구와 관련 논의의 입장을 구분하여 소개하는 것이 누락되어있다. 앞으로 서술될 논증 순서를 번호를 사용하여 명확하게 안내한다. 
...
상호성의 원칙과 이것이 충분주의적 관점에서 충족되어야 한다는 것을 논리적으로 설명하고 있다. 다만 학자들의 주장을 나열하는데 그치기 보다는 관련하여 예시를 쉽게 풀어서 설명하면 이해에 도움이 될 것 같다예상 반론은 논리적인 한계를 지적하는 것 같지 않다. 이에 대해서도 충분성의 원칙의 내용을 설명하는 닐슨의 주장에 대한 설명이 부족하여 어느 지점에서 논리적인 반박을 이어가고 있는지 파악하기 어렵다.
...
결론 마지막 문단은 미래전망적이고 논문의 주장을 강조할 수 있지만 이론적인 논의에 그치고 있다가 '한국 사회에서 논쟁을 불러일으킨 연금개혁안'을 언급하는 점에서 혼란을 불러일으킨다. 그리고 이를 언급한 해당 문장 역시 주술관계가 호응하지 않아 어색하다. 마지막 문단은 제거하는 방향으로 가도 될 것 같다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

각각의 개별 문장들이 매끄럽지 않은 경우가 다수 있다. 기본적으로 주술 호응관계를 잘 보아야 할 것 같다. 또한 거의 모든 주장이 학자들의 의견을 빌리는데, 그렇다고 해서 각 주장들의 정당성이 증명되는 것이 아니다. 주장을 제시하고 이에 관한 추가 설명들이 더 보충되면 좋겠다. 

### B. 논증에 대한 평가

본론은 충분주의적 관점에서 상호성의 원칙을 충족하는 공정연금제도가 올바르다는 주장을 하고 있다. 다만 딜레마가 무엇인지 명확하게 드러나지 않고, 본론의 논증은 어떤 방식인지 잘 구체화되지 않는다. 어떠한 주장에 대해 옹호하거나 비판하기 보다는 여러 조건들을 나열하고 그에 대한 당위성을 제시하는 방식이라는 느낌을 지울 수 없다. 예상 반론 부분은 불연속성의 문제를 지적하는데, 이에 대한 반박이 논제의 주장을 강화한다고 볼 수 없다. 반박 자체를 충분성 원칙을 근거로 들고 있는데, 그렇다고 해서 공적연금제도가 충분성의 원칙을 따라야 한다는 주장이 강화되진 않는다. 