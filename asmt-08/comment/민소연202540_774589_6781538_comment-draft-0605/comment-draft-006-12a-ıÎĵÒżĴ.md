---
title: 006-12 민소연의 코멘트a (과제-08) 
layout: home
nav_order: 12
parent: 006-16 정현호 (과제-08)
permalink: /asmt-08/006-16/comment-006-12
---
...
경제적인 지표를 토대로 귀납적인 결론에 다다르고 있는데, 증거나 사례가 부족하다. 예를 들어, 보험료율 인하가 필수적인 것을 그냥 납득할 수도 있지만, 예시를 들어 설명하면 좋을 것 같다. 보험료율이 10%-->5%가 되었을 때 원래 내던 돈에 비해 얼마나 차이 날 수 있는 건지 예시를 들어주면 실질적으로 와닿을 것 같다.
...
딜레마가 명확하다. 그러나 그와 관련한 세부 내용의 서술이 더 필요해보이고, 결론에서도 이를 다시 언급하면 좋을 것 같다.
...
국민연금 제도의 개혁방향과 관련하여 보험료율을 인상해야한다는 논제가 명확하고 이를 학술적 근거를 들어 설명하고 있다.
...
논문의 주요 논증 전략이 무엇인지 명확하게 판단되지 않는다. 문제점을 설명하는 데에는 경제적인 지표를 통한 귀납적인 과정이 중요한데, 결론에 다다르는 과정에서는 연역의 과정이라고 굳이 말할 수 있겠으나 그 구조가 불분명하다. 
...
- **종합적 평가**: 인용 자료들이 권위 있고, 출처의 표기가 명확하다. 논제를 증명하는 데에 있어 중요한 참고문헌 또한 그 핵심을 잘 설명하고 있다. 
...
1,2,3문단을 나눌 필요는 없어보인다. 또한 딜레마에 관한 선행 연구가 언급되어 있지 않고 논증 전략과 관련해 번로나 구문을 통한 안내가 부족해보인다.
...
각각의 주장을 하는 근거는 경제적인 지표나열이 대부분이다. 따라서 결론에 다다르는 과정 또한 경제적인 지표와 관련하여 논리적으로 이루어지면 좋을 것 같다. 또한 경제 지표 그 자체가 유의미하여 이것이 시사하는 바를 피상적으로만 소개하기보다는 구체적으로 왜 그것을 시사하는지 설명하면 좋겠다. 본론에서 '제도적 신뢰 회복과 긴밀히~필요성'과 그 세부 내용인 두단락은 이미 앞에서 진술한 부분이므로 빼도 될 것 같다. 각각의 항목을 세분화하는 것은 문단을 나누고 있는 것 만으로 그 역할을 다하고 있기 때문에 각각의 문단을 매끄럽게 이어서 서술해도 될 것 같다. 항목을 사용했을 때에 읽기에 편하긴하지만 어느 위치를 읽고 있는지 오히려 헷갈린다.사회적 신뢰 형성이론과 관련하여 보험료율 인상을 주장하는 데에 근거로서 중요해보이는데, 보험료율 인하가 왜 '정치적 신호'로 작용하는지는 증거가 불충분해보인다. 중간중간 논리적인 근거를 넣어주면 좋을 것 같다. 
...
본론의 내용이 요약되어 있으나 적다고 느껴진다. 각각의 주장만 나열하기 보다는 왜 그런 결론에 도달했었는지도 추가적으로 설명하면 좋을 것 같다. 

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

문장들의 표현이 명확하고 읽기 쉽다. 문단은 항목을 너무 세부화하기보다는 구절로서 항목화하면 좋을 것 같다. 또한 과도하게 긴문장의 경우 쉼표를 사용하기보다는 문장 자체를 분리하는 것이 읽기의 편의성에 좋아보인다.  

### B. 논증에 대한 평가

서론에서 먼저 논증 전략과 논증 구조의 내용에 대해 간략히 제시를 해준다면 좋겠다. 본론 부분에서도 그에 맞게 문단을 나누고 결론에서도 다시 논증 구조를 요약하여 드러내면 좋을 것 같다. 