---
title: 006-09 김건우의 코멘트b (과제-08) 
layout: home
nav_order: 9
parent: 006-08 권혁규 (과제-08)
permalink: /asmt-08/006-08/comment-006-08
---
...
- **종합적 평가**: 논제에서 *우리나라*라로 구체화하는 이유가 있는지 궁금하다. 본론을 보면 우리나라라는 특수성이 언급될 이유가 없다.
...
- **종합적 평가**: 기본소득의 경제적 영향과 관련된 논쟁을 잘 드러난다.
...
- **종합적 평가**: 글에서 인용이 내주로 명확히 이루어지고 있다.
...
#### **5. 서론 작성 종합 평가**: 
기본소득과 관련된 선행연구들이 명확하게 언급되었다. 서술 순서도 번호를 매겨서 시각적으로 알아보기 쉽다.
...
#### **4. 결론 작성 종합 평가**: 
글의 함의와 한계를 제시하고, 글의 논증 구조를 요약하면서 글을 마무리하고 있다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가
논제에서 우리나라라는 특수성을 언급할 이유가 없다. 글에서 우리나라가 아닌 보편적인 차원에서 기본소득을 논의하고 있기 때문이다.

### B. 논증에 대한 평가
논증에서 대등소비후생 지표의 역할이 조금 애매모호하다. 이 지표가 거시적으로 여러 요소를 고려한다는 장점을 고려해서 사용한 것 같다. 하지만 노동 공급의 감소와 자본 축적의 어려움 그 자체만으로 기본소득의 한계가 드러나지는 않는가? 즉 대등소비후생 지표의 위치가 논증에서 명확하지 않다.