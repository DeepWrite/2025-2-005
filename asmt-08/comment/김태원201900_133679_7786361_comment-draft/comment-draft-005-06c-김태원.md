---
title: 005-06 김태원의 코멘트c (과제-08) 
layout: home
nav_order: 06
parent: 005-25 이다은 (과제-08)
permalink: /asmt-08/005-25/comment-005-06
---
...
- **종합적 평가**: 학술논문보다는 현실의 제도, 판결 등에 치우쳐 있다.
...
#### **5. 서론 작성 종합 평가**: 
전반적으로 체크리스트 기준에 부합하나, 기존의 학술적 논의에 대한 소개가 부실하다. 참고로, 서론 마지막 문단 [2]에 '자작성'이라고 오타가 있다.
...
#### **3. 본론 작성 종합 평가**: 
연역 논증을 표방하고 있으나, 저작성 보호를 위한 3가지 요건은 대부분 판례나, 지침과 같은 현실적인 제도에 기반하여 논증을 수행하고 있다는 점에서 아쉬움이 있다. 판례도 이론을 바탕으로 이루어진다는 점을 고려할 때, 해당 논의를 이끌어 낸 원천적인 학술적 배경을 통해 논증을 수행했으면 더 설득력이 있었을 것으로 생각된다.
또한, 옹호의 논거로 "AI 활용 창작물을 무보호 상태의 공공재로 방치할 경우, 개별 주체가 축적한 데이터 모델, 알고리즘 등이 사회적으로 당연한 것이 되면서 AI 기반 지식 구조 전체가 침식되는 역설적인 결과가 발생할 수 있다"라는 주장을 하고 있는데, 논리적 흐름이 지나치게 생략되어 있어 설득력이 부족하다. 세부적인 논증 과정이 더 개선될 여지가 있다는 점에서 아쉽다.
...
#### **4. 결론 작성 종합 평가**: 
전반적인 내용을 총망라하여 좋은 결론을 구성하고 있다. 다만, 본 논고의 논의를 한계를 명확히 설정하지 않고 있다는 점에서 개선이 필요해 보인다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

한국어 논문에서 일반적으로 영문을 직접사용하지는 않는다는 점(e.g. "meaningful human control"이라고 명명하면서-)을 고려하여, 개선하면 좋을 것 같다.

### B. 논증에 대한 평가

앞에서 충분히 명기하였듯이, 세부적인 논리적 흐름, 학술적인 논의의 부족 등의 보완이 필요한 지점들이 있으므로 이를 개선하면 좋은 논증이 될 것으로 기대된다.