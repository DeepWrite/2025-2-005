---
title: 006-05 김태연의 코멘트c (과제-08) 
layout: home
nav_order: 05
parent: 006-22 김동희 (과제-08)
permalink: /asmt-08/006-22/comment-006-05
---
...
- **종합적 평가**: 일부 문단에서는 동일한 주장의 반복처럼 보이는 문장이 병렬적으로 나열되면서 중심 주장과 보조 주장의 위계가 명확하게 구분되지 않습니다. ‘자유’, ‘노동’, ‘선택’, ‘간섭’ 등의 용어가 여러 번 등장하면서도 때로는 각 맥락에서의 뉘앙스 차이가 드러나지 않아 의미가 평면화되는 경향이 있습니다. 중요한 개념은 글의 초반에서 더 세밀하게 정의했으면 좋았을 듯합니다.
...
- **종합적 평가**: 딜레마 구조를 좀 더 명시적으로 드러내도 좋을 듯합니다.
...
- **종합적 평가**: 전체 논증이 하나의 주장을 향해 계단식으로 치닫는 느낌을 더욱 주면 좋을 듯합니다. 선택권과 거절권이 이 각기 좋은 논증임에도, 상호 연계성이나 대립성을 더욱 논리적으로 정리해 주면 좋을 듯합니다. 약간은 동어반복으로도 느껴졌기 때문입니다. 선택과 거절이 하나의 자유를 구성하는 양면적 구조임을 강조하고, 이 두 권리가 기본소득을 통해 동시에 실현되지 않으면 의미가 없다는 식의 통합적 분석이 필요할 듯합니다.
...
#### **5. 서론 작성 종합 평가**: 
간단한 문장성분 오타만 수정하면 좋을 듯합니다. 또한 다른 입장을 설명할 떄 ~을 간과하고 있다는 단순히 기존 쟁점에 대한 입장 소개임에도 논제로 들어가기 위한 밑바탕으로 느껴져 표현을 수정하면 더욱 명확해질 것 같습니다.
...
#### **3. 본론 작성 종합 평가**: 경험적 사례로 재반박하는 부분이 좋은 듯합니다.
...
#### **4. 결론 작성 종합 평가**: 
정당성을 논증하는 것과 도입을 주장하는 것은 다르다는 언급은 학술적 글쓰기에서 흔히 생기는 오독 가능성을 미리 차단하는 좋은 문장인 듯합니다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

이 글은 서론-본론-결론 구조가 전형적으로 안정적이며, 논제 진술 및 전제 구성, 예시 제시, 요약 문장 배치 등에서 형식적 완성도가 높습니다. 단락 간 연결이 대부분 매끄럽지만, 소단락들이 병렬적 구조로 보이는 경향은 약간 보완될 여지가 있습니다. 개별 문장의 문체는 간결하고 학술적으로 적절하며, 서론과 결론에서의 자기 정체화가 명확합니다.

### B. 논증에 대한 평가

일부 개념(예: ‘자유’, ‘간섭’, ‘정당성’)에 대한 정의와 층위 구분이 더 치밀했다면 논증의 정밀도가 향상될 여지가 있습니다. 전제들 간의 추론 관계를 보다 명시적으로 서술하는 것도 향후 개선의 여지가 될 수 있을 것 같습니다.
