---
title: 006-02 김재겸의 코멘트a (과제-08) 
layout: home
nav_order: 02
parent: 006-04 박현규 (과제-08)
permalink: /asmt-08/006-04/comment-006-02
---
...
- 코멘트를 받는 학생: `006-04 박현후(코멘트를 받는 학생 이름)` 
...
어떠한 제도이든, 그 한계의 일탈과 남용은 부작용을 낳는다. 다만, 이 글에서는 정당해산제도가 남용된 경우를 전제로 글을 쓰고 있다. 정당해산제도는 원래 최후의 보루이다. 이는 통진당 해산사건 판례에서도 판시하는 바이다. 

즉, 딜렘마 설정에 있어 제도 자체의 문제가 아닌 제도의 남용의 부작용으로 설정했기 때문에 너무 보편적인 결론에 도달하는 점이 있다.
...
필자가 무슨 이야기를 하는 지는 명확하다. 다만 전술한 바와 같이 논의의 실익이 없다고 판단됨. 딜렘마를 조금 더 드러내면 좋겠다.
...
인용에 있어 문제는 없어 보인다. 다만 일부 학자의 경우 결론만을 인용하는 부분이 있어 아쉽다. 간략히라도 왜 그런 결과가 도출되는지 언급하면 좋겠음. 밀의 해악원칙과 같이.
...
표시한 바와 같음. 한편, 인권단체와 학계에서 선행 연구 및 학술 논쟁을 언급할 때, 한쪽 측면만 강조되고 있어 문제됨.
...
전술한 딜렘마의 문제와 같다. 당연히 정당해산제도의 남용은 독재 정치이다. 불가피한 점은 예상반론과 같다. 다만 재반박에서는 최후의 수단으로 이를 해야한다고 하는 점에서 예상반론을 반박하기 보다 그것이 옳음을 시인하는 데 그침.
...
적절한 결론이다. 그러나, 앞선 내용의 요약을 너무 충실히 한 감이 있다. 좀 더 가볍게 가도 될 것 같다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가

표현 자체는 흠 잡을 만한 곳이 없다. 다만, 일부 형식적 문제에 있어 결론이 너무 긴 호흡을 유지한다.

### B. 논증에 대한 평가

논증 자체는 논제를 도출함에 충분함. 다만, 정당해산 제도가 정상적으로 작동하는 경우를 다루지 않아 딜렘마가 적절하지 못하다.
추가적으로, 방어적 민주주의와, 자유주의의 한정중립성 개념을 활용하면 정당해산제도의 본질을 나타냄에 좀 더 좋을 듯 함. 잘 쓰셨습니다.