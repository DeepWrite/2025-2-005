---
title: 005-03 김성민의 코멘트c (과제-08) 
layout: home
nav_order: 03
parent: 005-15 김서진 (과제-08)
permalink: /asmt-08/005-15/comment-005-03
---
...
- **종합적 평가**: 명확한 표현을 기반으로 논증을 제시하고 서술하고 있다.
...
- **종합적 평가**: 논증을 진술하는 문장이 깔끔하게 명시되어있다.
...
- **종합적 평가**: 딜레마와 세부 쟁점은 명확히 정리되었다. 딜레마를 현실의 문제와 엮어 논의한다. 그러나 반론의 사례 외에는 왜 이 논의가 SNS에 대한 것인지를 알기 어려운 것 같다. 딜레마에서 SNS의 특성을 더 언급할 필요가 있어보인다. 가령 의견 교환의 플랫폼이 공공이 아닌 사기업에 의해 관리되는 것의 특징 등을 논의할 수 있겠다.
...
- **종합적 평가**: 딜레마에 대해 소개하는 과정에서 선행연구 검토를 조금 더 겸하면 좋을 것 같다.
...
- **종합적 평가**: 논증 전략의 내용을 설명하는 과정은 명료하다. 그러나 서론에서 어떤 전략을 활용하는지에 대해 언급하면 좋겠다. 가령, 혐오표현이 배제의 구조화를 낳기 때문에 해악이라는 전략이나, 과도한 혐오표현도 민주주의를 약화시킨다는 전략이 있겠다.
...
#### **5. 서론 작성 종합 평가**:
상술했듯, 서론에서 선행연구를 더 언급하면 좋겠다. 또한 왜 혐오표현이 아닌 SNS에 대한 논증인지가 분명하지 않다. 한편 쟁점은 명료하게 번호를 통해 나열하고 있지만, '논증'을 이와 같이 명시하진 않았다. 논증 또한 동일한 형식으로 정리해주면 더 좋을 것 같다.
...
#### **3. 본론 작성 종합 평가**: 검열이라는 표현을 쓰는데, 이는 표현에 대한 제한이 민주주의를 약화시킬 수 있다는 주장을 함축하는 표현인 것 같다. 그렇다면 두번째 질문을(표현의 자유는 어떤 조건 하에 제한될 수 있는가?) 민주주의를 해하지 않으면서 표현을 제한할 수 있는가? 로 바꾸는 것이 더 직접적인 논의를 펼치는 데에 도움이 될 것 같다. 표현의 제한이 민주주의를 약화시킨다는 주장으로는 postliberalism의 주장을 참고할 수 있겠다.
...
#### **4. 결론 작성 종합 평가**: 논의를 명료하게 잘 요약하고 있다.

## 5. 총평

### A. 표현, 형식, 구성 측면에 대한 평가
명료한 표현과 형식을 취하고 있으며, 구성도 잘 나타난다. 다만 딜레마 소개에서 선행연구를 더 제안하면 좋겠다. 또한 혐오표현이 아닌 SNS에 대한 논의인 이유를 구성 전반에서 부각시킬 필요가 있다. 한편, 쟁점이 아닌 논증을 서론에서 번호를 달아 정리해주고, 각 논증 과정에서 활용할 전략도 제시하면 좋을 것 같다.

### B. 논증에 대한 평가
논증은 잘 구성되었으나, 쟁점 2를 표현의 제한이 민주주의를 약화시키는가, 강화시키는가에 대한 논의로 재구성하는 것이 더 명확할 것 같다. 이는 자유주의와 포스트자유주의(Patrick Deneen 등)을 대립시키는 방식으로 발전시키고, 더 근본적인 반론과 재반박을 형성하는 데에 도움이 될것이다.